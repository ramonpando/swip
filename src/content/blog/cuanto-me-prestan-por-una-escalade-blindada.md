...
La diferencia en monto de préstamo entre una Escalade y sus contrapartes de la misma plataforma viene principalmente del valor base:

- **Escalade Platinum / ESV 2022-2024**: precio de lista $1,400,000 – $2,000,000 MXN
- **Suburban Premier 2022-2024**: precio de lista $1,100,000 – $1,400,000 MXN
- **Tahoe High Country 2022-2024**: precio de lista $1,000,000 – $1,300,000 MXN
...
|-----|---------|---------------|---------------------------|
| 2022-2024 | Platinum / ESV Platinum | NIJ III | $1,200,000 – $1,800,000 MXN |
| 2022-2024 | Premium Luxury | NIJ III | $1,000,000 – $1,500,000 MXN |
| 2020-2021 | Platinum | NIJ III | $800,000 – $1,200,000 MXN |
| 2018-2019 | Platinum | NIJ III | $600,000 – $950,000 MXN |
| Cualquier año | Premium / Sport | NIJ II | $500,000 – $800,000 MXN |
...
- **Menor liquidez relativa**: el ESV tiene menos compradores potenciales en el mercado mexicano que el modelo estándar — lo que el valuador considera en la estimación de valor de mercado
...
- **Versión**: Platinum es la de mayor valor. La diferencia entre Platinum y Premium Luxury puede ser de $150,000–$250,000 MXN en valor de mercado.
- **Año**: los modelos 2021+ tienen la nueva generación de plataforma — mayor diferencia de valor respecto a los modelos 2020 y anteriores.
- **Kilometraje y mantenimiento**: en agencia Cadillac con historial verificable sube el valor. El kilometraje aceptable para el segmento es similar al de la Suburban: ~15,000 km anuales como referencia.
- **Estado del interior**: la Escalade tiene interiores de lujo con materiales de alto costo — el estado del tapizado, madera y sistemas de entretenimiento afectan el valor de reventa.

### El blindaje

- **Nivel NIJ III vs. IV**: para una Escalade, el NIJ IV agrega valor significativo adicional. Un blindaje NIJ IV en una Escalade puede representar $600,000–$900,000 MXN sobre el valor base.
- **Armadora**: Solsegu, Epel y equivalentes. Para una Escalade, la armadora tiene mayor impacto en el valor que para vehículos de menor precio base.
- **Estado y año del blindaje**: blindaje de menos de 5 años en buen estado conserva la mayor parte de su valor. El valuador considera la antigüedad y el estado al revisar el activo.
...
Para evaluar si la modalidad sin resguardo tiene sentido para tu caso específico: [¿puedo seguir usando mi auto blindado durante el préstamo?](/blog/puedo-seguir-usando-mi-auto-blindado-durante-el-prestamo/)
...
Revisa la lista completa en [documentos para un auto blindado](/blog/documentos-para-empenar-o-dejar-en-garantia-un-auto-blindado/) y [requisitos generales](/requisitos/).
...
**¿Qué pasa si la Escalade tiene el sistema de suspensión neumática con algún problema?**
El estado de los sistemas del vehículo afecta la valuación. Sistemas costosos como la suspensión neumática de la Escalade, si tienen fallas conocidas, bajan el valor percibido de reventa y por tanto el monto ofrecido.

**¿Se puede hacer la valuación de una Escalade blindada en mi domicilio?**
Sí. Para vehículos de este peso y valor, la valuación a domicilio es parte del flujo normal — evita exponer el vehículo innecesariamente. El valuador va donde está el auto. El proceso completo está descrito en [¿cuánto tarda el proceso?](/blog/cuanto-tarda-el-proceso-para-auto-premium-blindado-exotico/)
